    ...
    <view class="page">
        ...
        <view class="express">
            <view class="top ali-c">
                <view class="picture">
                    <image class="img" mode="aspectFill" src="/static/images/person/icon-logistics.png"></image>
                </view>
                <view class="text">
                    <view class="text1">{{getLogInfo().logName}}</view>
                    <view class="text2">官方电话{{getLogInfo().phone}}</view>
                </view>
            </view>
            <view class="right">
                <view class="text">单号：{{wlInfo.list[0].deliverySn}}</view>
            </view>
        </view>
        ...
        <view class="content bgf">
            <view>
                ...
                <view class="flex list" :class="{one: index == 0 && item.status == 3}"
                    v-for="(item, index) in wlInfo.list" :key="index">
                    <view class="time">
                        <view class="day">{{item.updateTime.split(' ')[0]}}</view>
                        <view>{{item.updateTime.split(' ')[1]}}</view>
                    </view>
                    <view class="info flex1">
                        <view class="title">{{item.deliveryStatus}}</view>
        ...
        computed: {
            getLogInfo() {
                return () => {
                    ...
                    return statusText[this.wlInfo.deliveryCompany]
                }
            },
        },
        data() {
