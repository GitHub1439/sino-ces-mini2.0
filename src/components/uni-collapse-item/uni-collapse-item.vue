		...
		<view :class="{ 'uni-collapse-cell--disabled': disabled}" class="uni-collapse-cell__title"  @click="onClick">
			...
			<view :class="{ 'uni-collapse-cell__title-arrow-active': isOpen, 'uni-collapse-cell--animation': showAnimation === true }"
			 class="uni-collapse-cell__title-arrow">
				<image src="../../static/images/cart/down-arrow.png" mode="aspectFit"></image>
			...
			<image :class="{ 'uni-collapse-cell__title-arrow-active': isOpen, 'uni-collapse-cell--animation': showAnimation === true }"
			 class="uni-collapse-cell__title-arrow" src="../../static/images/cart/up-arrow.png" mode="aspectFit"></image>
            <!-- #endif -->
		</view>
